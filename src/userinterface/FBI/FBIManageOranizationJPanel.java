 ...
 * @author raunak
 */
public class FBIManageOranizationJPanel extends javax.swing.JPanel {
     ...
     */
    public FBIManageOranizationJPanel(JPanel userProcessContainer,OrganizationDirectory directory) {
        initComponents();
    ...
    private void populateCombo(){
        ...
        //for (Type type : Organization.Type.values()){
          //  if (!type.getValue().equals(Type.CDCManager.getValue()))
                organizationJComboBox.addItem(Type.FBI);
        //}
    }
